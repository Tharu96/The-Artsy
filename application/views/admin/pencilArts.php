...
<div class="card">
            ...
            <div id="carouselExampleCaptions" class="carousel slide" data-ride="carousel">
                ...
                <div class="carousel-inner">
                    <div class="carousel-item active">
                        <img src="<?= base_url() ?>assets/banner10.jpg "class="d-block w-100" alt="..." style="background-repeat: no-repeat; 
                                    width:100%;
                                    height:300px;
    ...
    <div class="btn-group">
        ...
        <?php  echo anchor('welcome/loadPencilArts', 'Pencil-Arts', ['class'=> 'btn btn-primary active'] );?>
