...
<div class="card">
            ...
            <div id="carouselExampleCaptions" class="carousel slide" data-ride="carousel">
                ...
                <div class="carousel-inner">
                    <div class="carousel-item active">
                        <img src="<?= base_url() ?>assets/banner5.jpg" class="d-block w-100" alt="..." style="background-repeat: no-repeat; 
                                    width:100%;
                                    height:300px;
    ...
    <div class="btn-group">
        ...
        <?php  echo anchor('welcome/loadRomanceArts', 'Romance', ['class'=> 'btn btn-primary active'] );?>
    ...
    <?php if(!empty($arts)){ foreach( $arts as $art){ ?>
        ...
        <div class="col-lg-4">
            <div class="thumbnail" >
                ...
                <button type="button" class="btn btn-primary">View</button><?php  echo anchor('welcome/updateArts', 'Update', ['class'=> 'btn btn-info  btn-sm'] ); ?>
